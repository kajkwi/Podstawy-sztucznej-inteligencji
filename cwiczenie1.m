...
dane_wejsciowe = [0 0 1 1;             %wartoœci wejœciowe pierwszej zmiennej
                  0 1 0 1];            %wartoœci wejœciowe drugiej zmiennej
wyjscie = [0 0 0 1];                   %wartoœci wyjœciowe bramki logicznej
plotpv(dane_wejsciowe, wyjscie);       %wykres z wynikami

%parametry uczenia - wspó³czynniki uczenia
